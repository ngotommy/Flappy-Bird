...
class Ship:
    ...
    def draw_ship(self):
        arcade.draw_rectangle_filled(self.pos_x, self.pos_y, 10, 40, arcade.color.YELLOW, self.tilt)
        arcade.draw_rectangle_filled(self.pos_x, self.pos_y, 30, 30, arcade.color.ORANGE, self.tilt)
        arcade.draw_arc_filled(self.pos_x, self.pos_y, 50, 50, arcade.color.GREEN, 0, 180, -self.tilt)
